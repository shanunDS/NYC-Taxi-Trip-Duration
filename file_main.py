...
daily_trip_duration = df['trip_duration'].resample('D').mean()

decomposition = seasonal_decompose(daily_trip_duration.dropna(), model='additive')

plt.figure(figsize=(14, 7))
plt.subplot(411)
plt.plot(daily_trip_duration, label='Original')
plt.legend(loc='best')
plt.subplot(412)
